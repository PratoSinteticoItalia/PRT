const CACHE_NAME = "psi-ops-shell-20260618-mobile-drawer-flow-fix";
const APP_SHELL = [
  "/",
  "/?shell=20260618-mobile-drawer-flow-fix",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260618-mobile-drawer-flow-fix",
  "/garden-planner.html?v=20260618-mobile-drawer-flow-fix&shell=20260618-mobile-drawer-flow-fix",
  ...
  "/garden-planner-page.js?v=20260618-mobile-drawer-flow-fix",
  "/styles.css?v=20260618-mobile-drawer-flow-fix",
  "/app.js?v=20260618-mobile-drawer-flow-fix",
  "/lib/order-money.js?v=20260618-mobile-drawer-flow-fix",
  "/lib/geo.js?v=20260618-mobile-drawer-flow-fix",
  "/lib/comuni-regioni.js?v=20260618-mobile-drawer-flow-fix",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260618-mobile-drawer-flow-fix",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260618-mobile-drawer-flow-fix",
  "/sales-suite/generator.html?embedded=1&v=20260618-mobile-drawer-flow-fix&shell=20260618-mobile-drawer-flow-fix",
  "/sales-suite/generator-bridge.js?v=20260618-mobile-drawer-flow-fix",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260618-mobile-drawer-flow-fix",
  "/vendor/html2pdf.bundle.min.js?v=20260618-mobile-drawer-flow-fix",
];
