const CACHE_NAME = "psi-ops-shell-20260805-fix-topbar-opaque-mobile";
const APP_SHELL = [
  "/",
  "/?shell=20260805-fix-topbar-opaque-mobile",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260805-fix-topbar-opaque-mobile",
  "/garden-planner.html?v=20260805-fix-topbar-opaque-mobile&shell=20260805-fix-topbar-opaque-mobile",
  ...
  "/garden-planner-page.js?v=20260805-fix-topbar-opaque-mobile",
  "/styles.css?v=20260805-fix-topbar-opaque-mobile",
  "/app.js?v=20260805-fix-topbar-opaque-mobile",
  "/lib/order-money.js?v=20260805-fix-topbar-opaque-mobile",
  "/lib/geo.js?v=20260805-fix-topbar-opaque-mobile",
  "/lib/comuni-regioni.js?v=20260805-fix-topbar-opaque-mobile",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260805-fix-topbar-opaque-mobile",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260805-fix-topbar-opaque-mobile",
  "/vendor/signature_pad.umd.min.js?v=20260805-fix-topbar-opaque-mobile",
  "/vendor/html2pdf.bundle.min.js?v=20260805-fix-topbar-opaque-mobile",
];
