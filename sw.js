const CACHE_NAME = "psi-ops-shell-20260811-ddt-mobile-scroll";
const APP_SHELL = [
  "/",
  "/?shell=20260811-ddt-mobile-scroll",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260811-ddt-mobile-scroll",
  "/garden-planner.html?v=20260811-ddt-mobile-scroll&shell=20260811-ddt-mobile-scroll",
  ...
  "/garden-planner-page.js?v=20260811-ddt-mobile-scroll",
  "/styles.css?v=20260811-ddt-mobile-scroll",
  "/app.js?v=20260811-ddt-mobile-scroll",
  "/lib/order-money.js?v=20260811-ddt-mobile-scroll",
  "/lib/geo.js?v=20260811-ddt-mobile-scroll",
  "/lib/comuni-regioni.js?v=20260811-ddt-mobile-scroll",
  "/lib/sales-assignment.js?v=20260811-ddt-mobile-scroll",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260811-ddt-mobile-scroll",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260811-ddt-mobile-scroll",
  "/vendor/signature_pad.umd.min.js?v=20260811-ddt-mobile-scroll",
  "/vendor/html2pdf.bundle.min.js?v=20260811-ddt-mobile-scroll",
];
