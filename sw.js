const CACHE_NAME = "psi-ops-shell-20260716-inventario-fix-apri-v4";
const APP_SHELL = [
  "/",
  "/?shell=20260716-inventario-fix-apri-v4",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260716-inventario-fix-apri-v4",
  "/garden-planner.html?v=20260716-inventario-fix-apri-v4&shell=20260716-inventario-fix-apri-v4",
  ...
  "/garden-planner-page.js?v=20260716-inventario-fix-apri-v4",
  "/styles.css?v=20260716-inventario-fix-apri-v4",
  "/app.js?v=20260716-inventario-fix-apri-v4",
  "/lib/order-money.js?v=20260716-inventario-fix-apri-v4",
  "/lib/geo.js?v=20260716-inventario-fix-apri-v4",
  "/lib/comuni-regioni.js?v=20260716-inventario-fix-apri-v4",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260716-inventario-fix-apri-v4",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260716-inventario-fix-apri-v4",
  "/vendor/signature_pad.umd.min.js?v=20260716-inventario-fix-apri-v4",
  "/vendor/html2pdf.bundle.min.js?v=20260716-inventario-fix-apri-v4",
];
