const CACHE_NAME = "psi-ops-shell-20260609-fix-routing-logistica-pose";
const APP_SHELL = [
  "/",
  "/?shell=20260609-fix-routing-logistica-pose",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260609-fix-routing-logistica-pose",
  "/garden-planner.html?v=20260609-fix-routing-logistica-pose&shell=20260609-fix-routing-logistica-pose",
  ...
  "/garden-planner-page.js?v=20260609-fix-routing-logistica-pose",
  "/styles.css?v=20260609-fix-routing-logistica-pose",
  "/app.js?v=20260609-fix-routing-logistica-pose",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260609-fix-routing-logistica-pose",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260609-fix-routing-logistica-pose",
  "/sales-suite/generator.html?embedded=1&v=20260609-fix-routing-logistica-pose&shell=20260609-fix-routing-logistica-pose",
  "/sales-suite/generator-bridge.js?v=20260609-fix-routing-logistica-pose",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260609-fix-routing-logistica-pose",
];
