const CACHE_NAME = "psi-ops-shell-20260918-routing-labels-kpi";
const APP_SHELL = [
  "/",
  "/?shell=20260918-routing-labels-kpi",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260918-routing-labels-kpi",
  "/garden-planner.html?v=20260918-routing-labels-kpi&shell=20260918-routing-labels-kpi",
  ...
  "/garden-planner-page.js?v=20260918-routing-labels-kpi",
  "/styles.css?v=20260918-routing-labels-kpi",
  "/app.js?v=20260918-routing-labels-kpi",
  "/lib/order-money.js?v=20260918-routing-labels-kpi",
  "/lib/geo.js?v=20260918-routing-labels-kpi",
  "/lib/comuni-regioni.js?v=20260918-routing-labels-kpi",
  "/lib/sales-assignment.js?v=20260918-routing-labels-kpi",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260918-routing-labels-kpi",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260918-routing-labels-kpi",
  "/vendor/signature_pad.umd.min.js?v=20260918-routing-labels-kpi",
  "/vendor/html2pdf.bundle.min.js?v=20260918-routing-labels-kpi",
];
