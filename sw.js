const CACHE_NAME = "psi-ops-shell-20260805-fix-shipping-in-coda-count";
const APP_SHELL = [
  "/",
  "/?shell=20260805-fix-shipping-in-coda-count",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260805-fix-shipping-in-coda-count",
  "/garden-planner.html?v=20260805-fix-shipping-in-coda-count&shell=20260805-fix-shipping-in-coda-count",
  ...
  "/garden-planner-page.js?v=20260805-fix-shipping-in-coda-count",
  "/styles.css?v=20260805-fix-shipping-in-coda-count",
  "/app.js?v=20260805-fix-shipping-in-coda-count",
  "/lib/order-money.js?v=20260805-fix-shipping-in-coda-count",
  "/lib/geo.js?v=20260805-fix-shipping-in-coda-count",
  "/lib/comuni-regioni.js?v=20260805-fix-shipping-in-coda-count",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260805-fix-shipping-in-coda-count",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260805-fix-shipping-in-coda-count",
  "/vendor/signature_pad.umd.min.js?v=20260805-fix-shipping-in-coda-count",
  "/vendor/html2pdf.bundle.min.js?v=20260805-fix-shipping-in-coda-count",
];
