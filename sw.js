const CACHE_NAME = "psi-ops-shell-20260531-tracking-cliente-token";
const APP_SHELL = [
  "/",
  "/?shell=20260531-tracking-cliente-token",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260531-tracking-cliente-token",
  "/garden-planner.html?v=20260531-tracking-cliente-token&shell=20260531-tracking-cliente-token",
  ...
  "/garden-planner-page.js?v=20260531-tracking-cliente-token",
  "/styles.css?v=20260531-tracking-cliente-token",
  "/app.js?v=20260531-tracking-cliente-token",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260531-tracking-cliente-token",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260531-tracking-cliente-token",
  "/sales-suite/generator.html?embedded=1&v=20260531-tracking-cliente-token&shell=20260531-tracking-cliente-token",
  "/sales-suite/generator-bridge.js?v=20260531-tracking-cliente-token",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260531-tracking-cliente-token",
];
