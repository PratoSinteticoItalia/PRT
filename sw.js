const CACHE_NAME = "psi-ops-shell-20260726-attendance-payroll";
const APP_SHELL = [
  "/",
  "/?shell=20260726-attendance-payroll",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260726-attendance-payroll",
  "/garden-planner.html?v=20260726-attendance-payroll&shell=20260726-attendance-payroll",
  ...
  "/garden-planner-page.js?v=20260726-attendance-payroll",
  "/styles.css?v=20260726-attendance-payroll",
  "/app.js?v=20260726-attendance-payroll",
  "/lib/order-money.js?v=20260726-attendance-payroll",
  "/lib/geo.js?v=20260726-attendance-payroll",
  "/lib/comuni-regioni.js?v=20260726-attendance-payroll",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260726-attendance-payroll",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260726-attendance-payroll",
  "/vendor/signature_pad.umd.min.js?v=20260726-attendance-payroll",
  "/vendor/html2pdf.bundle.min.js?v=20260726-attendance-payroll",
];
