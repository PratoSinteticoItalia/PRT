const CACHE_NAME = "psi-ops-shell-20260810-mobile-scroll-polish";
const APP_SHELL = [
  "/",
  "/?shell=20260810-mobile-scroll-polish",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260810-mobile-scroll-polish",
  "/garden-planner.html?v=20260810-mobile-scroll-polish&shell=20260810-mobile-scroll-polish",
  ...
  "/garden-planner-page.js?v=20260810-mobile-scroll-polish",
  "/styles.css?v=20260810-mobile-scroll-polish",
  "/app.js?v=20260810-mobile-scroll-polish",
  "/lib/order-money.js?v=20260810-mobile-scroll-polish",
  "/lib/geo.js?v=20260810-mobile-scroll-polish",
  "/lib/comuni-regioni.js?v=20260810-mobile-scroll-polish",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260810-mobile-scroll-polish",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260810-mobile-scroll-polish",
  "/vendor/signature_pad.umd.min.js?v=20260810-mobile-scroll-polish",
  "/vendor/html2pdf.bundle.min.js?v=20260810-mobile-scroll-polish",
];
