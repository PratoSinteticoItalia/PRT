const CACHE_NAME = "psi-ops-shell-20260609-ordini-btn-spacing";
const APP_SHELL = [
  "/",
  "/?shell=20260609-ordini-btn-spacing",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260609-ordini-btn-spacing",
  "/garden-planner.html?v=20260609-ordini-btn-spacing&shell=20260609-ordini-btn-spacing",
  ...
  "/garden-planner-page.js?v=20260609-ordini-btn-spacing",
  "/styles.css?v=20260609-ordini-btn-spacing",
  "/app.js?v=20260609-ordini-btn-spacing",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260609-ordini-btn-spacing",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260609-ordini-btn-spacing",
  "/sales-suite/generator.html?embedded=1&v=20260609-ordini-btn-spacing&shell=20260609-ordini-btn-spacing",
  "/sales-suite/generator-bridge.js?v=20260609-ordini-btn-spacing",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260609-ordini-btn-spacing",
];
