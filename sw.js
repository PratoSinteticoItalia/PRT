const CACHE_NAME = "psi-ops-shell-20260529-timesheet-hotfix-immutable";
const APP_SHELL = [
  "/",
  "/?shell=20260529-timesheet-hotfix-immutable",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260529-timesheet-hotfix-immutable",
  "/garden-planner.html?v=20260529-timesheet-hotfix-immutable&shell=20260529-timesheet-hotfix-immutable",
  ...
  "/garden-planner-page.js?v=20260529-timesheet-hotfix-immutable",
  "/styles.css?v=20260529-timesheet-hotfix-immutable",
  "/app.js?v=20260529-timesheet-hotfix-immutable",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260529-timesheet-hotfix-immutable",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260529-timesheet-hotfix-immutable",
  "/sales-suite/generator.html?embedded=1&v=20260529-timesheet-hotfix-immutable&shell=20260529-timesheet-hotfix-immutable",
  "/sales-suite/generator-bridge.js?v=20260529-timesheet-hotfix-immutable",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260529-timesheet-hotfix-immutable",
];
