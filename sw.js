const CACHE_NAME = "psi-ops-shell-20260615-preventivo-foto-icone";
const APP_SHELL = [
  "/",
  "/?shell=20260615-preventivo-foto-icone",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260615-preventivo-foto-icone",
  "/garden-planner.html?v=20260615-preventivo-foto-icone&shell=20260615-preventivo-foto-icone",
  ...
  "/garden-planner-page.js?v=20260615-preventivo-foto-icone",
  "/styles.css?v=20260615-preventivo-foto-icone",
  "/app.js?v=20260615-preventivo-foto-icone",
  "/lib/order-money.js?v=20260615-preventivo-foto-icone",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260615-preventivo-foto-icone",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260615-preventivo-foto-icone",
  "/sales-suite/generator.html?embedded=1&v=20260615-preventivo-foto-icone&shell=20260615-preventivo-foto-icone",
  "/sales-suite/generator-bridge.js?v=20260615-preventivo-foto-icone",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260615-preventivo-foto-icone",
  "/vendor/html2pdf.bundle.min.js?v=20260615-preventivo-foto-icone",
];
