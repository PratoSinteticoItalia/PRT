const CACHE_NAME = "psi-ops-shell-20260614-hardening-fase1";
const APP_SHELL = [
  "/",
  "/?shell=20260614-hardening-fase1",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260614-hardening-fase1",
  "/garden-planner.html?v=20260614-hardening-fase1&shell=20260614-hardening-fase1",
  ...
  "/garden-planner-page.js?v=20260614-hardening-fase1",
  "/styles.css?v=20260614-hardening-fase1",
  "/app.js?v=20260614-hardening-fase1",
  "/lib/order-money.js?v=20260614-hardening-fase1",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260614-hardening-fase1",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260614-hardening-fase1",
  "/sales-suite/generator.html?embedded=1&v=20260614-hardening-fase1&shell=20260614-hardening-fase1",
  "/sales-suite/generator-bridge.js?v=20260614-hardening-fase1",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260614-hardening-fase1",
];
