const CACHE_NAME = "psi-ops-shell-20260527-imap-health-v5";
const APP_SHELL = [
  "/",
  "/?shell=20260527-imap-health-v5",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260527-imap-health-v5",
  "/garden-planner.html?v=20260527-imap-health-v5&shell=20260527-imap-health-v5",
  ...
  "/garden-planner-page.js?v=20260527-imap-health-v5",
  "/styles.css?v=20260527-imap-health-v5",
  "/app.js?v=20260527-imap-health-v5",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260527-imap-health-v5",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260527-imap-health-v5",
  "/sales-suite/generator.html?embedded=1&v=20260527-imap-health-v5&shell=20260527-imap-health-v5",
  "/sales-suite/generator-bridge.js?v=20260527-imap-health-v5",
