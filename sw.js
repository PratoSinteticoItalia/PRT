const CACHE_NAME = "psi-ops-shell-20260629-kanban-mobile-tap-to-move";
const APP_SHELL = [
  "/",
  "/?shell=20260629-kanban-mobile-tap-to-move",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260629-kanban-mobile-tap-to-move",
  "/garden-planner.html?v=20260629-kanban-mobile-tap-to-move&shell=20260629-kanban-mobile-tap-to-move",
  ...
  "/garden-planner-page.js?v=20260629-kanban-mobile-tap-to-move",
  "/styles.css?v=20260629-kanban-mobile-tap-to-move",
  "/app.js?v=20260629-kanban-mobile-tap-to-move",
  "/lib/order-money.js?v=20260629-kanban-mobile-tap-to-move",
  "/lib/geo.js?v=20260629-kanban-mobile-tap-to-move",
  "/lib/comuni-regioni.js?v=20260629-kanban-mobile-tap-to-move",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260629-kanban-mobile-tap-to-move",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260629-kanban-mobile-tap-to-move",
  "/sales-suite/generator.html?embedded=1&v=20260629-kanban-mobile-tap-to-move&shell=20260629-kanban-mobile-tap-to-move",
  "/sales-suite/generator-bridge.js?v=20260629-kanban-mobile-tap-to-move",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260629-kanban-mobile-tap-to-move",
  "/vendor/html2pdf.bundle.min.js?v=20260629-kanban-mobile-tap-to-move",
];
