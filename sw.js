const CACHE_NAME = "psi-ops-shell-20260613-inbox-drawer-redesign";
const APP_SHELL = [
  "/",
  "/?shell=20260613-inbox-drawer-redesign",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260613-inbox-drawer-redesign",
  "/garden-planner.html?v=20260613-inbox-drawer-redesign&shell=20260613-inbox-drawer-redesign",
  ...
  "/garden-planner-page.js?v=20260613-inbox-drawer-redesign",
  "/styles.css?v=20260613-inbox-drawer-redesign",
  "/app.js?v=20260613-inbox-drawer-redesign",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260613-inbox-drawer-redesign",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260613-inbox-drawer-redesign",
  "/sales-suite/generator.html?embedded=1&v=20260613-inbox-drawer-redesign&shell=20260613-inbox-drawer-redesign",
  "/sales-suite/generator-bridge.js?v=20260613-inbox-drawer-redesign",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260613-inbox-drawer-redesign",
];
