const CACHE_NAME = "psi-ops-shell-20260728-orders-mobile-detail-stack";
const APP_SHELL = [
  "/",
  "/?shell=20260728-orders-mobile-detail-stack",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260728-orders-mobile-detail-stack",
  "/garden-planner.html?v=20260728-orders-mobile-detail-stack&shell=20260728-orders-mobile-detail-stack",
  ...
  "/garden-planner-page.js?v=20260728-orders-mobile-detail-stack",
  "/styles.css?v=20260728-orders-mobile-detail-stack",
  "/app.js?v=20260728-orders-mobile-detail-stack",
  "/lib/order-money.js?v=20260728-orders-mobile-detail-stack",
  "/lib/geo.js?v=20260728-orders-mobile-detail-stack",
  "/lib/comuni-regioni.js?v=20260728-orders-mobile-detail-stack",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260728-orders-mobile-detail-stack",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260728-orders-mobile-detail-stack",
  "/vendor/signature_pad.umd.min.js?v=20260728-orders-mobile-detail-stack",
  "/vendor/html2pdf.bundle.min.js?v=20260728-orders-mobile-detail-stack",
];
