const CACHE_NAME = "psi-ops-shell-20260521-add-accessories";
const APP_SHELL = [
  "/",
  "/?shell=20260521-add-accessories",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260521-add-accessories",
  "/garden-planner.html?v=20260521-add-accessories&shell=20260521-add-accessories",
  ...
  "/garden-planner-page.js?v=20260521-add-accessories",
  "/styles.css?v=20260521-add-accessories",
  "/app.js?v=20260521-add-accessories",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
