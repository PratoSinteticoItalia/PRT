const CACHE_NAME = "psi-ops-shell-20260612-logistica-kanban-clean";
const APP_SHELL = [
  "/",
  "/?shell=20260612-logistica-kanban-clean",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260612-logistica-kanban-clean",
  "/garden-planner.html?v=20260612-logistica-kanban-clean&shell=20260612-logistica-kanban-clean",
  ...
  "/garden-planner-page.js?v=20260612-logistica-kanban-clean",
  "/styles.css?v=20260612-logistica-kanban-clean",
  "/app.js?v=20260612-logistica-kanban-clean",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260612-logistica-kanban-clean",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260612-logistica-kanban-clean",
  "/sales-suite/generator.html?embedded=1&v=20260612-logistica-kanban-clean&shell=20260612-logistica-kanban-clean",
  "/sales-suite/generator-bridge.js?v=20260612-logistica-kanban-clean",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260612-logistica-kanban-clean",
];
