const CACHE_NAME = "psi-ops-shell-20260514-commit-fix-201";
const APP_SHELL = [
  "/",
  "/?shell=20260514-commit-fix-201",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260514-commit-fix-201",
  "/garden-planner.html?v=20260514-commit-fix-201&shell=20260514-commit-fix-201",
  ...
  "/garden-planner-page.js?v=20260514-commit-fix-201",
  "/styles.css?v=20260514-commit-fix-201",
  "/app.js?v=20260514-commit-fix-201",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/sales-suite/generator.html?embedded=1&v=20260514-commit-fix-201&shell=20260514-commit-fix-201",
  "/sales-suite/generator-bridge.js?v=20260514-commit-fix-201",
