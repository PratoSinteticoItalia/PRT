const CACHE_NAME = "psi-ops-shell-20260731-ddt-daily-email-automation";
const APP_SHELL = [
  "/",
  "/?shell=20260731-ddt-daily-email-automation",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260731-ddt-daily-email-automation",
  "/garden-planner.html?v=20260731-ddt-daily-email-automation&shell=20260731-ddt-daily-email-automation",
  ...
  "/garden-planner-page.js?v=20260731-ddt-daily-email-automation",
  "/styles.css?v=20260731-ddt-daily-email-automation",
  "/app.js?v=20260731-ddt-daily-email-automation",
  "/lib/order-money.js?v=20260731-ddt-daily-email-automation",
  "/lib/geo.js?v=20260731-ddt-daily-email-automation",
  "/lib/comuni-regioni.js?v=20260731-ddt-daily-email-automation",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260731-ddt-daily-email-automation",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260731-ddt-daily-email-automation",
  "/vendor/signature_pad.umd.min.js?v=20260731-ddt-daily-email-automation",
  "/vendor/html2pdf.bundle.min.js?v=20260731-ddt-daily-email-automation",
];
