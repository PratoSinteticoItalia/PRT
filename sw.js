const CACHE_NAME = "psi-ops-shell-20260717-rivenditore-fase5";
const APP_SHELL = [
  "/",
  "/?shell=20260717-rivenditore-fase5",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260717-rivenditore-fase5",
  "/garden-planner.html?v=20260717-rivenditore-fase5&shell=20260717-rivenditore-fase5",
  ...
  "/garden-planner-page.js?v=20260717-rivenditore-fase5",
  "/styles.css?v=20260717-rivenditore-fase5",
  "/app.js?v=20260717-rivenditore-fase5",
  "/lib/order-money.js?v=20260717-rivenditore-fase5",
  "/lib/geo.js?v=20260717-rivenditore-fase5",
  "/lib/comuni-regioni.js?v=20260717-rivenditore-fase5",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260717-rivenditore-fase5",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260717-rivenditore-fase5",
  "/vendor/signature_pad.umd.min.js?v=20260717-rivenditore-fase5",
  "/vendor/html2pdf.bundle.min.js?v=20260717-rivenditore-fase5",
];
