const CACHE_NAME = "psi-ops-shell-20260802-richieste-redesign";
const APP_SHELL = [
  "/",
  "/?shell=20260802-richieste-redesign",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260802-richieste-redesign",
  "/garden-planner.html?v=20260802-richieste-redesign&shell=20260802-richieste-redesign",
  ...
  "/garden-planner-page.js?v=20260802-richieste-redesign",
  "/styles.css?v=20260802-richieste-redesign",
  "/app.js?v=20260802-richieste-redesign",
  "/lib/order-money.js?v=20260802-richieste-redesign",
  "/lib/geo.js?v=20260802-richieste-redesign",
  "/lib/comuni-regioni.js?v=20260802-richieste-redesign",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260802-richieste-redesign",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260802-richieste-redesign",
  "/vendor/signature_pad.umd.min.js?v=20260802-richieste-redesign",
  "/vendor/html2pdf.bundle.min.js?v=20260802-richieste-redesign",
];
