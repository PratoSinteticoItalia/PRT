const CACHE_NAME = "psi-ops-shell-20260609-fix-routing-explicit";
const APP_SHELL = [
  "/",
  "/?shell=20260609-fix-routing-explicit",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260609-fix-routing-explicit",
  "/garden-planner.html?v=20260609-fix-routing-explicit&shell=20260609-fix-routing-explicit",
  ...
  "/garden-planner-page.js?v=20260609-fix-routing-explicit",
  "/styles.css?v=20260609-fix-routing-explicit",
  "/app.js?v=20260609-fix-routing-explicit",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260609-fix-routing-explicit",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260609-fix-routing-explicit",
  "/sales-suite/generator.html?embedded=1&v=20260609-fix-routing-explicit&shell=20260609-fix-routing-explicit",
  "/sales-suite/generator-bridge.js?v=20260609-fix-routing-explicit",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260609-fix-routing-explicit",
];
