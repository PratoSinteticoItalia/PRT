const CACHE_NAME = "psi-ops-shell-20260608-crm-v2-effective-date";
const APP_SHELL = [
  "/",
  "/?shell=20260608-crm-v2-effective-date",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260608-crm-v2-effective-date",
  "/garden-planner.html?v=20260608-crm-v2-effective-date&shell=20260608-crm-v2-effective-date",
  ...
  "/garden-planner-page.js?v=20260608-crm-v2-effective-date",
  "/styles.css?v=20260608-crm-v2-effective-date",
  "/app.js?v=20260608-crm-v2-effective-date",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260608-crm-v2-effective-date",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260608-crm-v2-effective-date",
  "/sales-suite/generator.html?embedded=1&v=20260608-crm-v2-effective-date&shell=20260608-crm-v2-effective-date",
  "/sales-suite/generator-bridge.js?v=20260608-crm-v2-effective-date",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260608-crm-v2-effective-date",
];
