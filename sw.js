const CACHE_NAME = "psi-ops-shell-20260518-crew-only-253";
const APP_SHELL = [
  "/",
  "/?shell=20260518-crew-only-253",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260518-crew-only-253",
  "/garden-planner.html?v=20260518-crew-only-253&shell=20260518-crew-only-253",
  ...
  "/garden-planner-page.js?v=20260518-crew-only-253",
  "/styles.css?v=20260518-crew-only-253",
  "/app.js?v=20260518-crew-only-253",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/sales-suite/generator.html?embedded=1&v=20260518-crew-only-253&shell=20260518-crew-only-253",
  "/sales-suite/generator-bridge.js?v=20260518-crew-only-253",
