const CACHE_NAME = "psi-ops-shell-20260811-crm-flow-hardening";
const APP_SHELL = [
  "/",
  "/?shell=20260811-crm-flow-hardening",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260811-crm-flow-hardening",
  "/garden-planner.html?v=20260811-crm-flow-hardening&shell=20260811-crm-flow-hardening",
  ...
  "/garden-planner-page.js?v=20260811-crm-flow-hardening",
  "/styles.css?v=20260811-crm-flow-hardening",
  "/app.js?v=20260811-crm-flow-hardening",
  "/lib/order-money.js?v=20260811-crm-flow-hardening",
  "/lib/geo.js?v=20260811-crm-flow-hardening",
  "/lib/comuni-regioni.js?v=20260811-crm-flow-hardening",
  "/lib/sales-assignment.js?v=20260811-crm-flow-hardening",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260811-crm-flow-hardening",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260811-crm-flow-hardening",
  "/vendor/signature_pad.umd.min.js?v=20260811-crm-flow-hardening",
  "/vendor/html2pdf.bundle.min.js?v=20260811-crm-flow-hardening",
];
