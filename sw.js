const CACHE_NAME = "psi-ops-shell-20260529-timesheet-banner-fallback";
const APP_SHELL = [
  "/",
  "/?shell=20260529-timesheet-banner-fallback",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260529-timesheet-banner-fallback",
  "/garden-planner.html?v=20260529-timesheet-banner-fallback&shell=20260529-timesheet-banner-fallback",
  ...
  "/garden-planner-page.js?v=20260529-timesheet-banner-fallback",
  "/styles.css?v=20260529-timesheet-banner-fallback",
  "/app.js?v=20260529-timesheet-banner-fallback",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260529-timesheet-banner-fallback",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260529-timesheet-banner-fallback",
  "/sales-suite/generator.html?embedded=1&v=20260529-timesheet-banner-fallback&shell=20260529-timesheet-banner-fallback",
  "/sales-suite/generator-bridge.js?v=20260529-timesheet-banner-fallback",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260529-timesheet-banner-fallback",
];
