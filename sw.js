const CACHE_NAME = "psi-ops-shell-20260513-layout-fix-193";
const APP_SHELL = [
  "/",
  "/?shell=20260513-layout-fix-193",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260513-layout-fix-193",
  "/garden-planner.html?v=20260513-layout-fix-193&shell=20260513-layout-fix-193",
  ...
  "/garden-planner-page.js?v=20260513-layout-fix-193",
  "/styles.css?v=20260513-layout-fix-193",
  "/app.js?v=20260513-layout-fix-193",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/sales-suite/generator.html?embedded=1&v=20260513-layout-fix-193&shell=20260513-layout-fix-193",
  "/sales-suite/generator-bridge.js?v=20260513-layout-fix-193",
