const CACHE_NAME = "psi-ops-shell-20260416-shipping-sample-visibility-38";
const APP_SHELL = [
  "/",
  "/?shell=20260416-shipping-sample-visibility-38",
  "/index.html",
  "/garden-planner.html",
  ...
  "/styles.css?v=20260416-shipping-sample-visibility-38",
  "/app.js?v=20260416-shipping-sample-visibility-38",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
