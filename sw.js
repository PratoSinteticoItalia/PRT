const CACHE_NAME = "psi-ops-shell-20260608-ordini-merge-materiali";
const APP_SHELL = [
  "/",
  "/?shell=20260608-ordini-merge-materiali",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260608-ordini-merge-materiali",
  "/garden-planner.html?v=20260608-ordini-merge-materiali&shell=20260608-ordini-merge-materiali",
  ...
  "/garden-planner-page.js?v=20260608-ordini-merge-materiali",
  "/styles.css?v=20260608-ordini-merge-materiali",
  "/app.js?v=20260608-ordini-merge-materiali",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260608-ordini-merge-materiali",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260608-ordini-merge-materiali",
  "/sales-suite/generator.html?embedded=1&v=20260608-ordini-merge-materiali&shell=20260608-ordini-merge-materiali",
  "/sales-suite/generator-bridge.js?v=20260608-ordini-merge-materiali",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260608-ordini-merge-materiali",
];
