const CACHE_NAME = "psi-ops-shell-20260527-imap-debug-v7";
const APP_SHELL = [
  "/",
  "/?shell=20260527-imap-debug-v7",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260527-imap-debug-v7",
  "/garden-planner.html?v=20260527-imap-debug-v7&shell=20260527-imap-debug-v7",
  ...
  "/garden-planner-page.js?v=20260527-imap-debug-v7",
  "/styles.css?v=20260527-imap-debug-v7",
  "/app.js?v=20260527-imap-debug-v7",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260527-imap-debug-v7",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260527-imap-debug-v7",
  "/sales-suite/generator.html?embedded=1&v=20260527-imap-debug-v7&shell=20260527-imap-debug-v7",
  "/sales-suite/generator-bridge.js?v=20260527-imap-debug-v7",
