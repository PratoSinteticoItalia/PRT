const CACHE_NAME = "psi-ops-shell-20260415-shell-reset-33";
const APP_SHELL = [
  "/",
  "/?shell=20260415-shell-reset-33",
  "/index.html",
  "/garden-planner.html",
  ...
  "/styles.css?v=20260415-shell-reset-33",
  "/app.js?v=20260415-shell-reset-33",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
