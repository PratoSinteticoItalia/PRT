const CACHE_NAME = "psi-ops-shell-20260612-logistica-drawer-viewport";
const APP_SHELL = [
  "/",
  "/?shell=20260612-logistica-drawer-viewport",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260612-logistica-drawer-viewport",
  "/garden-planner.html?v=20260612-logistica-drawer-viewport&shell=20260612-logistica-drawer-viewport",
  ...
  "/garden-planner-page.js?v=20260612-logistica-drawer-viewport",
  "/styles.css?v=20260612-logistica-drawer-viewport",
  "/app.js?v=20260612-logistica-drawer-viewport",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260612-logistica-drawer-viewport",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260612-logistica-drawer-viewport",
  "/sales-suite/generator.html?embedded=1&v=20260612-logistica-drawer-viewport&shell=20260612-logistica-drawer-viewport",
  "/sales-suite/generator-bridge.js?v=20260612-logistica-drawer-viewport",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260612-logistica-drawer-viewport",
];
