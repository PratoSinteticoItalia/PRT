const CACHE_NAME = "psi-ops-shell-20260729-notif-order-label";
const APP_SHELL = [
  "/",
  "/?shell=20260729-notif-order-label",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260729-notif-order-label",
  "/garden-planner.html?v=20260729-notif-order-label&shell=20260729-notif-order-label",
  ...
  "/garden-planner-page.js?v=20260729-notif-order-label",
  "/styles.css?v=20260729-notif-order-label",
  "/app.js?v=20260729-notif-order-label",
  "/lib/order-money.js?v=20260729-notif-order-label",
  "/lib/geo.js?v=20260729-notif-order-label",
  "/lib/comuni-regioni.js?v=20260729-notif-order-label",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260729-notif-order-label",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260729-notif-order-label",
  "/vendor/signature_pad.umd.min.js?v=20260729-notif-order-label",
  "/vendor/html2pdf.bundle.min.js?v=20260729-notif-order-label",
];
