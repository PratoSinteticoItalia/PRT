const CACHE_NAME = "psi-ops-shell-20260615-preventivo-print-fix";
const APP_SHELL = [
  "/",
  "/?shell=20260615-preventivo-print-fix",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260615-preventivo-print-fix",
  "/garden-planner.html?v=20260615-preventivo-print-fix&shell=20260615-preventivo-print-fix",
  ...
  "/garden-planner-page.js?v=20260615-preventivo-print-fix",
  "/styles.css?v=20260615-preventivo-print-fix",
  "/app.js?v=20260615-preventivo-print-fix",
  "/lib/order-money.js?v=20260615-preventivo-print-fix",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260615-preventivo-print-fix",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260615-preventivo-print-fix",
  "/sales-suite/generator.html?embedded=1&v=20260615-preventivo-print-fix&shell=20260615-preventivo-print-fix",
  "/sales-suite/generator-bridge.js?v=20260615-preventivo-print-fix",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260615-preventivo-print-fix",
];
