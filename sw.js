const CACHE_NAME = "psi-ops-shell-20260613-marketing-persistenza-server";
const APP_SHELL = [
  "/",
  "/?shell=20260613-marketing-persistenza-server",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260613-marketing-persistenza-server",
  "/garden-planner.html?v=20260613-marketing-persistenza-server&shell=20260613-marketing-persistenza-server",
  ...
  "/garden-planner-page.js?v=20260613-marketing-persistenza-server",
  "/styles.css?v=20260613-marketing-persistenza-server",
  "/app.js?v=20260613-marketing-persistenza-server",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260613-marketing-persistenza-server",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260613-marketing-persistenza-server",
  "/sales-suite/generator.html?embedded=1&v=20260613-marketing-persistenza-server&shell=20260613-marketing-persistenza-server",
  "/sales-suite/generator-bridge.js?v=20260613-marketing-persistenza-server",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260613-marketing-persistenza-server",
];
