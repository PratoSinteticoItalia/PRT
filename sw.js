const CACHE_NAME = "psi-ops-shell-20260820-pareti-verdi-catalogo";
const APP_SHELL = [
  "/",
  "/?shell=20260820-pareti-verdi-catalogo",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260820-pareti-verdi-catalogo",
  "/garden-planner.html?v=20260820-pareti-verdi-catalogo&shell=20260820-pareti-verdi-catalogo",
  ...
  "/garden-planner-page.js?v=20260820-pareti-verdi-catalogo",
  "/styles.css?v=20260820-pareti-verdi-catalogo",
  "/app.js?v=20260820-pareti-verdi-catalogo",
  "/lib/order-money.js?v=20260820-pareti-verdi-catalogo",
  "/lib/geo.js?v=20260820-pareti-verdi-catalogo",
  "/lib/comuni-regioni.js?v=20260820-pareti-verdi-catalogo",
  "/lib/sales-assignment.js?v=20260820-pareti-verdi-catalogo",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260820-pareti-verdi-catalogo",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260820-pareti-verdi-catalogo",
  "/vendor/signature_pad.umd.min.js?v=20260820-pareti-verdi-catalogo",
  "/vendor/html2pdf.bundle.min.js?v=20260820-pareti-verdi-catalogo",
];
