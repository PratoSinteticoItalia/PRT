const CACHE_NAME = "psi-ops-shell-20260419-process-debug-fix-49";
const APP_SHELL = [
  "/",
  "/?shell=20260419-process-debug-fix-49",
  "/index.html",
  "/garden-planner.html",
  ...
  "/styles.css?v=20260419-process-debug-fix-49",
  "/app.js?v=20260419-process-debug-fix-49",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
