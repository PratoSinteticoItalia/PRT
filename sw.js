const CACHE_NAME = "psi-ops-shell-20260509-shopify-sync-fix-142";
const APP_SHELL = [
  "/",
  "/?shell=20260509-shopify-sync-fix-142",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260509-shopify-sync-fix-142",
  "/garden-planner.html?v=20260509-shopify-sync-fix-142&shell=20260509-shopify-sync-fix-142",
  ...
  "/garden-planner-page.js?v=20260509-shopify-sync-fix-142",
  "/styles.css?v=20260509-shopify-sync-fix-142",
  "/app.js?v=20260509-shopify-sync-fix-142",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/sales-suite/generator.html?embedded=1&v=20260509-shopify-sync-fix-142&shell=20260509-shopify-sync-fix-142",
  "/sales-suite/generator-bridge.js?v=20260509-shopify-sync-fix-142",
