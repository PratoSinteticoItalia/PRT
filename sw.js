const CACHE_NAME = "psi-ops-shell-20260808-inventory-rename-product";
const APP_SHELL = [
  "/",
  "/?shell=20260808-inventory-rename-product",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260808-inventory-rename-product",
  "/garden-planner.html?v=20260808-inventory-rename-product&shell=20260808-inventory-rename-product",
  ...
  "/garden-planner-page.js?v=20260808-inventory-rename-product",
  "/styles.css?v=20260808-inventory-rename-product",
  "/app.js?v=20260808-inventory-rename-product",
  "/lib/order-money.js?v=20260808-inventory-rename-product",
  "/lib/geo.js?v=20260808-inventory-rename-product",
  "/lib/comuni-regioni.js?v=20260808-inventory-rename-product",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260808-inventory-rename-product",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260808-inventory-rename-product",
  "/vendor/signature_pad.umd.min.js?v=20260808-inventory-rename-product",
  "/vendor/html2pdf.bundle.min.js?v=20260808-inventory-rename-product",
];
