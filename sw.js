const CACHE_NAME = "psi-ops-shell-20260514-custom-turf-199";
const APP_SHELL = [
  "/",
  "/?shell=20260514-custom-turf-199",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260514-custom-turf-199",
  "/garden-planner.html?v=20260514-custom-turf-199&shell=20260514-custom-turf-199",
  ...
  "/garden-planner-page.js?v=20260514-custom-turf-199",
  "/styles.css?v=20260514-custom-turf-199",
  "/app.js?v=20260514-custom-turf-199",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/sales-suite/generator.html?embedded=1&v=20260514-custom-turf-199&shell=20260514-custom-turf-199",
  "/sales-suite/generator-bridge.js?v=20260514-custom-turf-199",
