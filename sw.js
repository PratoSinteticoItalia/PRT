const CACHE_NAME = "psi-ops-shell-20260824-timesheet-absence-fix";
const APP_SHELL = [
  "/",
  "/?shell=20260824-timesheet-absence-fix",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260824-timesheet-absence-fix",
  "/garden-planner.html?v=20260824-timesheet-absence-fix&shell=20260824-timesheet-absence-fix",
  ...
  "/garden-planner-page.js?v=20260824-timesheet-absence-fix",
  "/styles.css?v=20260824-timesheet-absence-fix",
  "/app.js?v=20260824-timesheet-absence-fix",
  "/lib/order-money.js?v=20260824-timesheet-absence-fix",
  "/lib/geo.js?v=20260824-timesheet-absence-fix",
  "/lib/comuni-regioni.js?v=20260824-timesheet-absence-fix",
  "/lib/sales-assignment.js?v=20260824-timesheet-absence-fix",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260824-timesheet-absence-fix",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260824-timesheet-absence-fix",
  "/vendor/signature_pad.umd.min.js?v=20260824-timesheet-absence-fix",
  "/vendor/html2pdf.bundle.min.js?v=20260824-timesheet-absence-fix",
];
