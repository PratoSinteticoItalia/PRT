const CACHE_NAME = "psi-ops-shell-20260608-crm-v2-mobile-wa-scroll";
const APP_SHELL = [
  "/",
  "/?shell=20260608-crm-v2-mobile-wa-scroll",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260608-crm-v2-mobile-wa-scroll",
  "/garden-planner.html?v=20260608-crm-v2-mobile-wa-scroll&shell=20260608-crm-v2-mobile-wa-scroll",
  ...
  "/garden-planner-page.js?v=20260608-crm-v2-mobile-wa-scroll",
  "/styles.css?v=20260608-crm-v2-mobile-wa-scroll",
  "/app.js?v=20260608-crm-v2-mobile-wa-scroll",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260608-crm-v2-mobile-wa-scroll",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260608-crm-v2-mobile-wa-scroll",
  "/sales-suite/generator.html?embedded=1&v=20260608-crm-v2-mobile-wa-scroll&shell=20260608-crm-v2-mobile-wa-scroll",
  "/sales-suite/generator-bridge.js?v=20260608-crm-v2-mobile-wa-scroll",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260608-crm-v2-mobile-wa-scroll",
];
