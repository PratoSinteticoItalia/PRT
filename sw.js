const CACHE_NAME = "psi-ops-shell-20260726-marketing-stories";
const APP_SHELL = [
  "/",
  "/?shell=20260726-marketing-stories",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260726-marketing-stories",
  "/garden-planner.html?v=20260726-marketing-stories&shell=20260726-marketing-stories",
  ...
  "/garden-planner-page.js?v=20260726-marketing-stories",
  "/styles.css?v=20260726-marketing-stories",
  "/app.js?v=20260726-marketing-stories",
  "/lib/order-money.js?v=20260726-marketing-stories",
  "/lib/geo.js?v=20260726-marketing-stories",
  "/lib/comuni-regioni.js?v=20260726-marketing-stories",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260726-marketing-stories",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260726-marketing-stories",
  "/vendor/signature_pad.umd.min.js?v=20260726-marketing-stories",
  "/vendor/html2pdf.bundle.min.js?v=20260726-marketing-stories",
];
