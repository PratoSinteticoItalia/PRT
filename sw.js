const CACHE_NAME = "psi-ops-shell-20260802-fix-bulk-select-notif";
const APP_SHELL = [
  "/",
  "/?shell=20260802-fix-bulk-select-notif",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260802-fix-bulk-select-notif",
  "/garden-planner.html?v=20260802-fix-bulk-select-notif&shell=20260802-fix-bulk-select-notif",
  ...
  "/garden-planner-page.js?v=20260802-fix-bulk-select-notif",
  "/styles.css?v=20260802-fix-bulk-select-notif",
  "/app.js?v=20260802-fix-bulk-select-notif",
  "/lib/order-money.js?v=20260802-fix-bulk-select-notif",
  "/lib/geo.js?v=20260802-fix-bulk-select-notif",
  "/lib/comuni-regioni.js?v=20260802-fix-bulk-select-notif",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260802-fix-bulk-select-notif",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260802-fix-bulk-select-notif",
  "/vendor/signature_pad.umd.min.js?v=20260802-fix-bulk-select-notif",
  "/vendor/html2pdf.bundle.min.js?v=20260802-fix-bulk-select-notif",
];
