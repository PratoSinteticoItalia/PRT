const CACHE_NAME = "psi-ops-shell-20260529-timesheet-mvp";
const APP_SHELL = [
  "/",
  "/?shell=20260529-timesheet-mvp",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260529-timesheet-mvp",
  "/garden-planner.html?v=20260529-timesheet-mvp&shell=20260529-timesheet-mvp",
  ...
  "/garden-planner-page.js?v=20260529-timesheet-mvp",
  "/styles.css?v=20260529-timesheet-mvp",
  "/app.js?v=20260529-timesheet-mvp",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260529-timesheet-mvp",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260529-timesheet-mvp",
  "/sales-suite/generator.html?embedded=1&v=20260529-timesheet-mvp&shell=20260529-timesheet-mvp",
  "/sales-suite/generator-bridge.js?v=20260529-timesheet-mvp",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260529-timesheet-mvp",
];
