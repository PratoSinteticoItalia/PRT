const CACHE_NAME = "psi-ops-shell-20260731-shipping-card-ux-polish";
const APP_SHELL = [
  "/",
  "/?shell=20260731-shipping-card-ux-polish",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260731-shipping-card-ux-polish",
  "/garden-planner.html?v=20260731-shipping-card-ux-polish&shell=20260731-shipping-card-ux-polish",
  ...
  "/garden-planner-page.js?v=20260731-shipping-card-ux-polish",
  "/styles.css?v=20260731-shipping-card-ux-polish",
  "/app.js?v=20260731-shipping-card-ux-polish",
  "/lib/order-money.js?v=20260731-shipping-card-ux-polish",
  "/lib/geo.js?v=20260731-shipping-card-ux-polish",
  "/lib/comuni-regioni.js?v=20260731-shipping-card-ux-polish",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260731-shipping-card-ux-polish",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260731-shipping-card-ux-polish",
  "/vendor/signature_pad.umd.min.js?v=20260731-shipping-card-ux-polish",
  "/vendor/html2pdf.bundle.min.js?v=20260731-shipping-card-ux-polish",
];
