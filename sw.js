const CACHE_NAME = "psi-ops-shell-20260615-preventivo-salvapdf";
const APP_SHELL = [
  "/",
  "/?shell=20260615-preventivo-salvapdf",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260615-preventivo-salvapdf",
  "/garden-planner.html?v=20260615-preventivo-salvapdf&shell=20260615-preventivo-salvapdf",
  ...
  "/garden-planner-page.js?v=20260615-preventivo-salvapdf",
  "/styles.css?v=20260615-preventivo-salvapdf",
  "/app.js?v=20260615-preventivo-salvapdf",
  "/lib/order-money.js?v=20260615-preventivo-salvapdf",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260615-preventivo-salvapdf",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260615-preventivo-salvapdf",
  "/sales-suite/generator.html?embedded=1&v=20260615-preventivo-salvapdf&shell=20260615-preventivo-salvapdf",
  "/sales-suite/generator-bridge.js?v=20260615-preventivo-salvapdf",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260615-preventivo-salvapdf",
  "/vendor/html2pdf.bundle.min.js?v=20260615-preventivo-salvapdf",
];
