const CACHE_NAME = "psi-ops-shell-20260813-inv-manual-caption";
const APP_SHELL = [
  "/",
  "/?shell=20260813-inv-manual-caption",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260813-inv-manual-caption",
  "/garden-planner.html?v=20260813-inv-manual-caption&shell=20260813-inv-manual-caption",
  ...
  "/garden-planner-page.js?v=20260813-inv-manual-caption",
  "/styles.css?v=20260813-inv-manual-caption",
  "/app.js?v=20260813-inv-manual-caption",
  "/lib/order-money.js?v=20260813-inv-manual-caption",
  "/lib/geo.js?v=20260813-inv-manual-caption",
  "/lib/comuni-regioni.js?v=20260813-inv-manual-caption",
  "/lib/sales-assignment.js?v=20260813-inv-manual-caption",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260813-inv-manual-caption",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260813-inv-manual-caption",
  "/vendor/signature_pad.umd.min.js?v=20260813-inv-manual-caption",
  "/vendor/html2pdf.bundle.min.js?v=20260813-inv-manual-caption",
];
