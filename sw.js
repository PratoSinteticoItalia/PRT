const CACHE_NAME = "psi-ops-shell-20260612-logistica-drawer-no-estimate";
const APP_SHELL = [
  "/",
  "/?shell=20260612-logistica-drawer-no-estimate",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260612-logistica-drawer-no-estimate",
  "/garden-planner.html?v=20260612-logistica-drawer-no-estimate&shell=20260612-logistica-drawer-no-estimate",
  ...
  "/garden-planner-page.js?v=20260612-logistica-drawer-no-estimate",
  "/styles.css?v=20260612-logistica-drawer-no-estimate",
  "/app.js?v=20260612-logistica-drawer-no-estimate",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260612-logistica-drawer-no-estimate",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260612-logistica-drawer-no-estimate",
  "/sales-suite/generator.html?embedded=1&v=20260612-logistica-drawer-no-estimate&shell=20260612-logistica-drawer-no-estimate",
  "/sales-suite/generator-bridge.js?v=20260612-logistica-drawer-no-estimate",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260612-logistica-drawer-no-estimate",
];
