const CACHE_NAME = "psi-ops-shell-20260615-preventivo-barra-nome";
const APP_SHELL = [
  "/",
  "/?shell=20260615-preventivo-barra-nome",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260615-preventivo-barra-nome",
  "/garden-planner.html?v=20260615-preventivo-barra-nome&shell=20260615-preventivo-barra-nome",
  ...
  "/garden-planner-page.js?v=20260615-preventivo-barra-nome",
  "/styles.css?v=20260615-preventivo-barra-nome",
  "/app.js?v=20260615-preventivo-barra-nome",
  "/lib/order-money.js?v=20260615-preventivo-barra-nome",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260615-preventivo-barra-nome",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260615-preventivo-barra-nome",
  "/sales-suite/generator.html?embedded=1&v=20260615-preventivo-barra-nome&shell=20260615-preventivo-barra-nome",
  "/sales-suite/generator-bridge.js?v=20260615-preventivo-barra-nome",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260615-preventivo-barra-nome",
  "/vendor/html2pdf.bundle.min.js?v=20260615-preventivo-barra-nome",
];
