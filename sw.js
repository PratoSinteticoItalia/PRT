const CACHE_NAME = "psi-ops-shell-20260531-banner-dot-only";
const APP_SHELL = [
  "/",
  "/?shell=20260531-banner-dot-only",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260531-banner-dot-only",
  "/garden-planner.html?v=20260531-banner-dot-only&shell=20260531-banner-dot-only",
  ...
  "/garden-planner-page.js?v=20260531-banner-dot-only",
  "/styles.css?v=20260531-banner-dot-only",
  "/app.js?v=20260531-banner-dot-only",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260531-banner-dot-only",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260531-banner-dot-only",
  "/sales-suite/generator.html?embedded=1&v=20260531-banner-dot-only&shell=20260531-banner-dot-only",
  "/sales-suite/generator-bridge.js?v=20260531-banner-dot-only",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260531-banner-dot-only",
];
