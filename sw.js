const CACHE_NAME = "psi-ops-shell-20260807-mobile-native-fixes-round2";
const APP_SHELL = [
  "/",
  "/?shell=20260807-mobile-native-fixes-round2",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260807-mobile-native-fixes-round2",
  "/garden-planner.html?v=20260807-mobile-native-fixes-round2&shell=20260807-mobile-native-fixes-round2",
  ...
  "/garden-planner-page.js?v=20260807-mobile-native-fixes-round2",
  "/styles.css?v=20260807-mobile-native-fixes-round2",
  "/app.js?v=20260807-mobile-native-fixes-round2",
  "/lib/order-money.js?v=20260807-mobile-native-fixes-round2",
  "/lib/geo.js?v=20260807-mobile-native-fixes-round2",
  "/lib/comuni-regioni.js?v=20260807-mobile-native-fixes-round2",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260807-mobile-native-fixes-round2",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260807-mobile-native-fixes-round2",
  "/vendor/signature_pad.umd.min.js?v=20260807-mobile-native-fixes-round2",
  "/vendor/html2pdf.bundle.min.js?v=20260807-mobile-native-fixes-round2",
];
