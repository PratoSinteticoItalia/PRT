const CACHE_NAME = "psi-ops-shell-20260724-shipping-order-attachments";
const APP_SHELL = [
  "/",
  "/?shell=20260724-shipping-order-attachments",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260724-shipping-order-attachments",
  "/garden-planner.html?v=20260724-shipping-order-attachments&shell=20260724-shipping-order-attachments",
  ...
  "/garden-planner-page.js?v=20260724-shipping-order-attachments",
  "/styles.css?v=20260724-shipping-order-attachments",
  "/app.js?v=20260724-shipping-order-attachments",
  "/lib/order-money.js?v=20260724-shipping-order-attachments",
  "/lib/geo.js?v=20260724-shipping-order-attachments",
  "/lib/comuni-regioni.js?v=20260724-shipping-order-attachments",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260724-shipping-order-attachments",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260724-shipping-order-attachments",
  "/vendor/signature_pad.umd.min.js?v=20260724-shipping-order-attachments",
  "/vendor/html2pdf.bundle.min.js?v=20260724-shipping-order-attachments",
];
