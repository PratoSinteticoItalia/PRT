const CACHE_NAME = "psi-ops-shell-20260612-logistica-pipeline-fasi";
const APP_SHELL = [
  "/",
  "/?shell=20260612-logistica-pipeline-fasi",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260612-logistica-pipeline-fasi",
  "/garden-planner.html?v=20260612-logistica-pipeline-fasi&shell=20260612-logistica-pipeline-fasi",
  ...
  "/garden-planner-page.js?v=20260612-logistica-pipeline-fasi",
  "/styles.css?v=20260612-logistica-pipeline-fasi",
  "/app.js?v=20260612-logistica-pipeline-fasi",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260612-logistica-pipeline-fasi",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260612-logistica-pipeline-fasi",
  "/sales-suite/generator.html?embedded=1&v=20260612-logistica-pipeline-fasi&shell=20260612-logistica-pipeline-fasi",
  "/sales-suite/generator-bridge.js?v=20260612-logistica-pipeline-fasi",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260612-logistica-pipeline-fasi",
];
