const CACHE_NAME = "psi-ops-shell-20260726-absence-requests";
const APP_SHELL = [
  "/",
  "/?shell=20260726-absence-requests",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260726-absence-requests",
  "/garden-planner.html?v=20260726-absence-requests&shell=20260726-absence-requests",
  ...
  "/garden-planner-page.js?v=20260726-absence-requests",
  "/styles.css?v=20260726-absence-requests",
  "/app.js?v=20260726-absence-requests",
  "/lib/order-money.js?v=20260726-absence-requests",
  "/lib/geo.js?v=20260726-absence-requests",
  "/lib/comuni-regioni.js?v=20260726-absence-requests",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260726-absence-requests",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260726-absence-requests",
  "/vendor/signature_pad.umd.min.js?v=20260726-absence-requests",
  "/vendor/html2pdf.bundle.min.js?v=20260726-absence-requests",
];
