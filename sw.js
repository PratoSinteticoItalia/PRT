const CACHE_NAME = "psi-ops-shell-20260730-shipping-lane-color-swap";
const APP_SHELL = [
  "/",
  "/?shell=20260730-shipping-lane-color-swap",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260730-shipping-lane-color-swap",
  "/garden-planner.html?v=20260730-shipping-lane-color-swap&shell=20260730-shipping-lane-color-swap",
  ...
  "/garden-planner-page.js?v=20260730-shipping-lane-color-swap",
  "/styles.css?v=20260730-shipping-lane-color-swap",
  "/app.js?v=20260730-shipping-lane-color-swap",
  "/lib/order-money.js?v=20260730-shipping-lane-color-swap",
  "/lib/geo.js?v=20260730-shipping-lane-color-swap",
  "/lib/comuni-regioni.js?v=20260730-shipping-lane-color-swap",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260730-shipping-lane-color-swap",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260730-shipping-lane-color-swap",
  "/vendor/signature_pad.umd.min.js?v=20260730-shipping-lane-color-swap",
  "/vendor/html2pdf.bundle.min.js?v=20260730-shipping-lane-color-swap",
];
