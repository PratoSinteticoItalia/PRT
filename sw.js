const CACHE_NAME = "psi-ops-shell-20260805-fix-sotto-scorta-filter";
const APP_SHELL = [
  "/",
  "/?shell=20260805-fix-sotto-scorta-filter",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260805-fix-sotto-scorta-filter",
  "/garden-planner.html?v=20260805-fix-sotto-scorta-filter&shell=20260805-fix-sotto-scorta-filter",
  ...
  "/garden-planner-page.js?v=20260805-fix-sotto-scorta-filter",
  "/styles.css?v=20260805-fix-sotto-scorta-filter",
  "/app.js?v=20260805-fix-sotto-scorta-filter",
  "/lib/order-money.js?v=20260805-fix-sotto-scorta-filter",
  "/lib/geo.js?v=20260805-fix-sotto-scorta-filter",
  "/lib/comuni-regioni.js?v=20260805-fix-sotto-scorta-filter",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260805-fix-sotto-scorta-filter",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260805-fix-sotto-scorta-filter",
  "/vendor/signature_pad.umd.min.js?v=20260805-fix-sotto-scorta-filter",
  "/vendor/html2pdf.bundle.min.js?v=20260805-fix-sotto-scorta-filter",
];
