const CACHE_NAME = "psi-ops-shell-20260612-logistica-kanban-drawer";
const APP_SHELL = [
  "/",
  "/?shell=20260612-logistica-kanban-drawer",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260612-logistica-kanban-drawer",
  "/garden-planner.html?v=20260612-logistica-kanban-drawer&shell=20260612-logistica-kanban-drawer",
  ...
  "/garden-planner-page.js?v=20260612-logistica-kanban-drawer",
  "/styles.css?v=20260612-logistica-kanban-drawer",
  "/app.js?v=20260612-logistica-kanban-drawer",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260612-logistica-kanban-drawer",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260612-logistica-kanban-drawer",
  "/sales-suite/generator.html?embedded=1&v=20260612-logistica-kanban-drawer&shell=20260612-logistica-kanban-drawer",
  "/sales-suite/generator-bridge.js?v=20260612-logistica-kanban-drawer",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260612-logistica-kanban-drawer",
];
