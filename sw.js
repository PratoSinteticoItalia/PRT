const CACHE_NAME = "psi-ops-shell-20260521-green-toolbar";
const APP_SHELL = [
  "/",
  "/?shell=20260521-green-toolbar",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260521-green-toolbar",
  "/garden-planner.html?v=20260521-green-toolbar&shell=20260521-green-toolbar",
  ...
  "/garden-planner-page.js?v=20260521-green-toolbar",
  "/styles.css?v=20260521-green-toolbar",
  "/app.js?v=20260521-green-toolbar",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260521-green-toolbar",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260521-green-toolbar",
  "/sales-suite/generator.html?embedded=1&v=20260521-green-toolbar&shell=20260521-green-toolbar",
  "/sales-suite/generator-bridge.js?v=20260521-green-toolbar",
