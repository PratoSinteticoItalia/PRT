const CACHE_NAME = "psi-ops-shell-20260802-flat-background-no-grid";
const APP_SHELL = [
  "/",
  "/?shell=20260802-flat-background-no-grid",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260802-flat-background-no-grid",
  "/garden-planner.html?v=20260802-flat-background-no-grid&shell=20260802-flat-background-no-grid",
  ...
  "/garden-planner-page.js?v=20260802-flat-background-no-grid",
  "/styles.css?v=20260802-flat-background-no-grid",
  "/app.js?v=20260802-flat-background-no-grid",
  "/lib/order-money.js?v=20260802-flat-background-no-grid",
  "/lib/geo.js?v=20260802-flat-background-no-grid",
  "/lib/comuni-regioni.js?v=20260802-flat-background-no-grid",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260802-flat-background-no-grid",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260802-flat-background-no-grid",
  "/vendor/signature_pad.umd.min.js?v=20260802-flat-background-no-grid",
  "/vendor/html2pdf.bundle.min.js?v=20260802-flat-background-no-grid",
];
