const CACHE_NAME = "psi-ops-shell-20260810-error-toast-crm-cleanup";
const APP_SHELL = [
  "/",
  "/?shell=20260810-error-toast-crm-cleanup",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260810-error-toast-crm-cleanup",
  "/garden-planner.html?v=20260810-error-toast-crm-cleanup&shell=20260810-error-toast-crm-cleanup",
  ...
  "/garden-planner-page.js?v=20260810-error-toast-crm-cleanup",
  "/styles.css?v=20260810-error-toast-crm-cleanup",
  "/app.js?v=20260810-error-toast-crm-cleanup",
  "/lib/order-money.js?v=20260810-error-toast-crm-cleanup",
  "/lib/geo.js?v=20260810-error-toast-crm-cleanup",
  "/lib/comuni-regioni.js?v=20260810-error-toast-crm-cleanup",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260810-error-toast-crm-cleanup",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260810-error-toast-crm-cleanup",
  "/vendor/signature_pad.umd.min.js?v=20260810-error-toast-crm-cleanup",
  "/vendor/html2pdf.bundle.min.js?v=20260810-error-toast-crm-cleanup",
];
