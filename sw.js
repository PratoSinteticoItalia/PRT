const CACHE_NAME = "psi-ops-shell-20260612-magazziniere-logistica-fix";
const APP_SHELL = [
  "/",
  "/?shell=20260612-magazziniere-logistica-fix",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260612-magazziniere-logistica-fix",
  "/garden-planner.html?v=20260612-magazziniere-logistica-fix&shell=20260612-magazziniere-logistica-fix",
  ...
  "/garden-planner-page.js?v=20260612-magazziniere-logistica-fix",
  "/styles.css?v=20260612-magazziniere-logistica-fix",
  "/app.js?v=20260612-magazziniere-logistica-fix",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260612-magazziniere-logistica-fix",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260612-magazziniere-logistica-fix",
  "/sales-suite/generator.html?embedded=1&v=20260612-magazziniere-logistica-fix&shell=20260612-magazziniere-logistica-fix",
  "/sales-suite/generator-bridge.js?v=20260612-magazziniere-logistica-fix",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260612-magazziniere-logistica-fix",
];
