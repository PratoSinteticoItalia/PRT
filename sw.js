const CACHE_NAME = "psi-ops-shell-20260811-bulk-vcard-contacts";
const APP_SHELL = [
  "/",
  "/?shell=20260811-bulk-vcard-contacts",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260811-bulk-vcard-contacts",
  "/garden-planner.html?v=20260811-bulk-vcard-contacts&shell=20260811-bulk-vcard-contacts",
  ...
  "/garden-planner-page.js?v=20260811-bulk-vcard-contacts",
  "/styles.css?v=20260811-bulk-vcard-contacts",
  "/app.js?v=20260811-bulk-vcard-contacts",
  "/lib/order-money.js?v=20260811-bulk-vcard-contacts",
  "/lib/geo.js?v=20260811-bulk-vcard-contacts",
  "/lib/comuni-regioni.js?v=20260811-bulk-vcard-contacts",
  "/lib/sales-assignment.js?v=20260811-bulk-vcard-contacts",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260811-bulk-vcard-contacts",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260811-bulk-vcard-contacts",
  "/vendor/signature_pad.umd.min.js?v=20260811-bulk-vcard-contacts",
  "/vendor/html2pdf.bundle.min.js?v=20260811-bulk-vcard-contacts",
];
