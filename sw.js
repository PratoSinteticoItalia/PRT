const CACHE_NAME = "psi-ops-shell-20260413-sales-requests-23";
const APP_SHELL = [
  "/",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner-page.js?v=20260413-sales-requests-23",
  "/styles.css?v=20260413-sales-requests-23",
  "/app.js?v=20260413-sales-requests-23",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
