const CACHE_NAME = "psi-ops-shell-20260715-ios-zoom-input-fix";
const APP_SHELL = [
  "/",
  "/?shell=20260715-ios-zoom-input-fix",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260715-ios-zoom-input-fix",
  "/garden-planner.html?v=20260715-ios-zoom-input-fix&shell=20260715-ios-zoom-input-fix",
  ...
  "/garden-planner-page.js?v=20260715-ios-zoom-input-fix",
  "/styles.css?v=20260715-ios-zoom-input-fix",
  "/app.js?v=20260715-ios-zoom-input-fix",
  "/lib/order-money.js?v=20260715-ios-zoom-input-fix",
  "/lib/geo.js?v=20260715-ios-zoom-input-fix",
  "/lib/comuni-regioni.js?v=20260715-ios-zoom-input-fix",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260715-ios-zoom-input-fix",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260715-ios-zoom-input-fix",
  "/vendor/signature_pad.umd.min.js?v=20260715-ios-zoom-input-fix",
  "/vendor/html2pdf.bundle.min.js?v=20260715-ios-zoom-input-fix",
];
