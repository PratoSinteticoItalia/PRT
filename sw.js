const CACHE_NAME = "psi-ops-shell-20260620-fix-msg-password-corta";
const APP_SHELL = [
  "/",
  "/?shell=20260620-fix-msg-password-corta",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260620-fix-msg-password-corta",
  "/garden-planner.html?v=20260620-fix-msg-password-corta&shell=20260620-fix-msg-password-corta",
  ...
  "/garden-planner-page.js?v=20260620-fix-msg-password-corta",
  "/styles.css?v=20260620-fix-msg-password-corta",
  "/app.js?v=20260620-fix-msg-password-corta",
  "/lib/order-money.js?v=20260620-fix-msg-password-corta",
  "/lib/geo.js?v=20260620-fix-msg-password-corta",
  "/lib/comuni-regioni.js?v=20260620-fix-msg-password-corta",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260620-fix-msg-password-corta",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260620-fix-msg-password-corta",
  "/sales-suite/generator.html?embedded=1&v=20260620-fix-msg-password-corta&shell=20260620-fix-msg-password-corta",
  "/sales-suite/generator-bridge.js?v=20260620-fix-msg-password-corta",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260620-fix-msg-password-corta",
  "/vendor/html2pdf.bundle.min.js?v=20260620-fix-msg-password-corta",
];
