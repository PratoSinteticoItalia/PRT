const CACHE_NAME = "psi-ops-shell-20260531-google-maps-link";
const APP_SHELL = [
  "/",
  "/?shell=20260531-google-maps-link",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260531-google-maps-link",
  "/garden-planner.html?v=20260531-google-maps-link&shell=20260531-google-maps-link",
  ...
  "/garden-planner-page.js?v=20260531-google-maps-link",
  "/styles.css?v=20260531-google-maps-link",
  "/app.js?v=20260531-google-maps-link",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260531-google-maps-link",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260531-google-maps-link",
  "/sales-suite/generator.html?embedded=1&v=20260531-google-maps-link&shell=20260531-google-maps-link",
  "/sales-suite/generator-bridge.js?v=20260531-google-maps-link",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260531-google-maps-link",
];
