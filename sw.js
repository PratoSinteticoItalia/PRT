const CACHE_NAME = "psi-ops-shell-20260725-supplier-ledger";
const APP_SHELL = [
  "/",
  "/?shell=20260725-supplier-ledger",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260725-supplier-ledger",
  "/garden-planner.html?v=20260725-supplier-ledger&shell=20260725-supplier-ledger",
  ...
  "/garden-planner-page.js?v=20260725-supplier-ledger",
  "/styles.css?v=20260725-supplier-ledger",
  "/app.js?v=20260725-supplier-ledger",
  "/lib/order-money.js?v=20260725-supplier-ledger",
  "/lib/geo.js?v=20260725-supplier-ledger",
  "/lib/comuni-regioni.js?v=20260725-supplier-ledger",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260725-supplier-ledger",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260725-supplier-ledger",
  "/vendor/signature_pad.umd.min.js?v=20260725-supplier-ledger",
  "/vendor/html2pdf.bundle.min.js?v=20260725-supplier-ledger",
];
