const CACHE_NAME = "psi-ops-shell-20260530-shell-loading-hard-failsafe";
const APP_SHELL = [
  "/",
  "/?shell=20260530-shell-loading-hard-failsafe",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260530-shell-loading-hard-failsafe",
  "/garden-planner.html?v=20260530-shell-loading-hard-failsafe&shell=20260530-shell-loading-hard-failsafe",
  ...
  "/garden-planner-page.js?v=20260530-shell-loading-hard-failsafe",
  "/styles.css?v=20260530-shell-loading-hard-failsafe",
  "/app.js?v=20260530-shell-loading-hard-failsafe",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260530-shell-loading-hard-failsafe",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260530-shell-loading-hard-failsafe",
  "/sales-suite/generator.html?embedded=1&v=20260530-shell-loading-hard-failsafe&shell=20260530-shell-loading-hard-failsafe",
  "/sales-suite/generator-bridge.js?v=20260530-shell-loading-hard-failsafe",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260530-shell-loading-hard-failsafe",
];
