const CACHE_NAME = "psi-ops-shell-20260808-mobile-topbar-hierarchy";
const APP_SHELL = [
  "/",
  "/?shell=20260808-mobile-topbar-hierarchy",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260808-mobile-topbar-hierarchy",
  "/garden-planner.html?v=20260808-mobile-topbar-hierarchy&shell=20260808-mobile-topbar-hierarchy",
  ...
  "/garden-planner-page.js?v=20260808-mobile-topbar-hierarchy",
  "/styles.css?v=20260808-mobile-topbar-hierarchy",
  "/app.js?v=20260808-mobile-topbar-hierarchy",
  "/lib/order-money.js?v=20260808-mobile-topbar-hierarchy",
  "/lib/geo.js?v=20260808-mobile-topbar-hierarchy",
  "/lib/comuni-regioni.js?v=20260808-mobile-topbar-hierarchy",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260808-mobile-topbar-hierarchy",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260808-mobile-topbar-hierarchy",
  "/vendor/signature_pad.umd.min.js?v=20260808-mobile-topbar-hierarchy",
  "/vendor/html2pdf.bundle.min.js?v=20260808-mobile-topbar-hierarchy",
];
