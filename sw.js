const CACHE_NAME = "psi-ops-shell-20260530-fix-bootloop";
const APP_SHELL = [
  "/",
  "/?shell=20260530-fix-bootloop",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260530-fix-bootloop",
  "/garden-planner.html?v=20260530-fix-bootloop&shell=20260530-fix-bootloop",
  ...
  "/garden-planner-page.js?v=20260530-fix-bootloop",
  "/styles.css?v=20260530-fix-bootloop",
  "/app.js?v=20260530-fix-bootloop",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260530-fix-bootloop",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260530-fix-bootloop",
  "/sales-suite/generator.html?embedded=1&v=20260530-fix-bootloop&shell=20260530-fix-bootloop",
  "/sales-suite/generator-bridge.js?v=20260530-fix-bootloop",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260530-fix-bootloop",
];
