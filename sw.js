const CACHE_NAME = "psi-ops-shell-20260825-warehouse-mobile-audit";
const APP_SHELL = [
  "/",
  "/?shell=20260825-warehouse-mobile-audit",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260825-warehouse-mobile-audit",
  "/garden-planner.html?v=20260825-warehouse-mobile-audit&shell=20260825-warehouse-mobile-audit",
  ...
  "/garden-planner-page.js?v=20260825-warehouse-mobile-audit",
  "/styles.css?v=20260825-warehouse-mobile-audit",
  "/app.js?v=20260825-warehouse-mobile-audit",
  "/lib/order-money.js?v=20260825-warehouse-mobile-audit",
  "/lib/geo.js?v=20260825-warehouse-mobile-audit",
  "/lib/comuni-regioni.js?v=20260825-warehouse-mobile-audit",
  "/lib/sales-assignment.js?v=20260825-warehouse-mobile-audit",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260825-warehouse-mobile-audit",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260825-warehouse-mobile-audit",
  "/vendor/signature_pad.umd.min.js?v=20260825-warehouse-mobile-audit",
  "/vendor/html2pdf.bundle.min.js?v=20260825-warehouse-mobile-audit",
];
