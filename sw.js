const CACHE_NAME = "psi-ops-shell-20260726-absence-request-queue";
const APP_SHELL = [
  "/",
  "/?shell=20260726-absence-request-queue",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260726-absence-request-queue",
  "/garden-planner.html?v=20260726-absence-request-queue&shell=20260726-absence-request-queue",
  ...
  "/garden-planner-page.js?v=20260726-absence-request-queue",
  "/styles.css?v=20260726-absence-request-queue",
  "/app.js?v=20260726-absence-request-queue",
  "/lib/order-money.js?v=20260726-absence-request-queue",
  "/lib/geo.js?v=20260726-absence-request-queue",
  "/lib/comuni-regioni.js?v=20260726-absence-request-queue",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260726-absence-request-queue",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260726-absence-request-queue",
  "/vendor/signature_pad.umd.min.js?v=20260726-absence-request-queue",
  "/vendor/html2pdf.bundle.min.js?v=20260726-absence-request-queue",
];
