const CACHE_NAME = "psi-ops-shell-20260416-shipping-sample-visibility-39";
const APP_SHELL = [
  "/",
  "/?shell=20260416-shipping-sample-visibility-39",
  "/index.html",
  "/garden-planner.html",
  ...
  "/styles.css?v=20260416-shipping-sample-visibility-39",
  "/app.js?v=20260416-shipping-sample-visibility-39",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
