const CACHE_NAME = "psi-ops-shell-20260612-logistica-kanban-polish";
const APP_SHELL = [
  "/",
  "/?shell=20260612-logistica-kanban-polish",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260612-logistica-kanban-polish",
  "/garden-planner.html?v=20260612-logistica-kanban-polish&shell=20260612-logistica-kanban-polish",
  ...
  "/garden-planner-page.js?v=20260612-logistica-kanban-polish",
  "/styles.css?v=20260612-logistica-kanban-polish",
  "/app.js?v=20260612-logistica-kanban-polish",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260612-logistica-kanban-polish",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260612-logistica-kanban-polish",
  "/sales-suite/generator.html?embedded=1&v=20260612-logistica-kanban-polish&shell=20260612-logistica-kanban-polish",
  "/sales-suite/generator-bridge.js?v=20260612-logistica-kanban-polish",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260612-logistica-kanban-polish",
];
