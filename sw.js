const CACHE_NAME = "psi-ops-shell-20260702-pose-kanban-grid-fix";
const APP_SHELL = [
  "/",
  "/?shell=20260702-pose-kanban-grid-fix",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260702-pose-kanban-grid-fix",
  "/garden-planner.html?v=20260702-pose-kanban-grid-fix&shell=20260702-pose-kanban-grid-fix",
  ...
  "/garden-planner-page.js?v=20260702-pose-kanban-grid-fix",
  "/styles.css?v=20260702-pose-kanban-grid-fix",
  "/app.js?v=20260702-pose-kanban-grid-fix",
  "/lib/order-money.js?v=20260702-pose-kanban-grid-fix",
  "/lib/geo.js?v=20260702-pose-kanban-grid-fix",
  "/lib/comuni-regioni.js?v=20260702-pose-kanban-grid-fix",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260702-pose-kanban-grid-fix",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260702-pose-kanban-grid-fix",
  "/sales-suite/generator.html?embedded=1&v=20260702-pose-kanban-grid-fix&shell=20260702-pose-kanban-grid-fix",
  "/sales-suite/generator-bridge.js?v=20260702-pose-kanban-grid-fix",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260702-pose-kanban-grid-fix",
  "/vendor/html2pdf.bundle.min.js?v=20260702-pose-kanban-grid-fix",
];
