const CACHE_NAME = "psi-ops-shell-20260701-pose-kanban-grid";
const APP_SHELL = [
  "/",
  "/?shell=20260701-pose-kanban-grid",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260701-pose-kanban-grid",
  "/garden-planner.html?v=20260701-pose-kanban-grid&shell=20260701-pose-kanban-grid",
  ...
  "/garden-planner-page.js?v=20260701-pose-kanban-grid",
  "/styles.css?v=20260701-pose-kanban-grid",
  "/app.js?v=20260701-pose-kanban-grid",
  "/lib/order-money.js?v=20260701-pose-kanban-grid",
  "/lib/geo.js?v=20260701-pose-kanban-grid",
  "/lib/comuni-regioni.js?v=20260701-pose-kanban-grid",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260701-pose-kanban-grid",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260701-pose-kanban-grid",
  "/sales-suite/generator.html?embedded=1&v=20260701-pose-kanban-grid&shell=20260701-pose-kanban-grid",
  "/sales-suite/generator-bridge.js?v=20260701-pose-kanban-grid",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260701-pose-kanban-grid",
  "/vendor/html2pdf.bundle.min.js?v=20260701-pose-kanban-grid",
];
