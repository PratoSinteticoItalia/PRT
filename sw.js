const CACHE_NAME = "psi-ops-shell-20260809-dashboard-command-center";
const APP_SHELL = [
  "/",
  "/?shell=20260809-dashboard-command-center",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260809-dashboard-command-center",
  "/garden-planner.html?v=20260809-dashboard-command-center&shell=20260809-dashboard-command-center",
  ...
  "/garden-planner-page.js?v=20260809-dashboard-command-center",
  "/styles.css?v=20260809-dashboard-command-center",
  "/app.js?v=20260809-dashboard-command-center",
  "/lib/order-money.js?v=20260809-dashboard-command-center",
  "/lib/geo.js?v=20260809-dashboard-command-center",
  "/lib/comuni-regioni.js?v=20260809-dashboard-command-center",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260809-dashboard-command-center",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260809-dashboard-command-center",
  "/vendor/signature_pad.umd.min.js?v=20260809-dashboard-command-center",
  "/vendor/html2pdf.bundle.min.js?v=20260809-dashboard-command-center",
];
