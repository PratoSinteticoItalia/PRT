const CACHE_NAME = "psi-ops-shell-20260820-deadcode-cleanup";
const APP_SHELL = [
  "/",
  "/?shell=20260820-deadcode-cleanup",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260820-deadcode-cleanup",
  "/garden-planner.html?v=20260820-deadcode-cleanup&shell=20260820-deadcode-cleanup",
  ...
  "/garden-planner-page.js?v=20260820-deadcode-cleanup",
  "/styles.css?v=20260820-deadcode-cleanup",
  "/app.js?v=20260820-deadcode-cleanup",
  "/lib/order-money.js?v=20260820-deadcode-cleanup",
  "/lib/geo.js?v=20260820-deadcode-cleanup",
  "/lib/comuni-regioni.js?v=20260820-deadcode-cleanup",
  "/lib/sales-assignment.js?v=20260820-deadcode-cleanup",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260820-deadcode-cleanup",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260820-deadcode-cleanup",
  "/vendor/signature_pad.umd.min.js?v=20260820-deadcode-cleanup",
  "/vendor/html2pdf.bundle.min.js?v=20260820-deadcode-cleanup",
];
