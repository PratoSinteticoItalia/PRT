const CACHE_NAME = "psi-ops-shell-20260613-pose-crew-colors";
const APP_SHELL = [
  "/",
  "/?shell=20260613-pose-crew-colors",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260613-pose-crew-colors",
  "/garden-planner.html?v=20260613-pose-crew-colors&shell=20260613-pose-crew-colors",
  ...
  "/garden-planner-page.js?v=20260613-pose-crew-colors",
  "/styles.css?v=20260613-pose-crew-colors",
  "/app.js?v=20260613-pose-crew-colors",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260613-pose-crew-colors",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260613-pose-crew-colors",
  "/sales-suite/generator.html?embedded=1&v=20260613-pose-crew-colors&shell=20260613-pose-crew-colors",
  "/sales-suite/generator-bridge.js?v=20260613-pose-crew-colors",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260613-pose-crew-colors",
];
