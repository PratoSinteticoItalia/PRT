const CACHE_NAME = "psi-ops-shell-20260509-equal-height-cols-152";
const APP_SHELL = [
  "/",
  "/?shell=20260509-equal-height-cols-152",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260509-equal-height-cols-152",
  "/garden-planner.html?v=20260509-equal-height-cols-152&shell=20260509-equal-height-cols-152",
  ...
  "/garden-planner-page.js?v=20260509-equal-height-cols-152",
  "/styles.css?v=20260509-equal-height-cols-152",
  "/app.js?v=20260509-equal-height-cols-152",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/sales-suite/generator.html?embedded=1&v=20260509-equal-height-cols-152&shell=20260509-equal-height-cols-152",
  "/sales-suite/generator-bridge.js?v=20260509-equal-height-cols-152",
