const CACHE_NAME = "psi-ops-shell-20260811-install-subview-drill";
const APP_SHELL = [
  "/",
  "/?shell=20260811-install-subview-drill",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260811-install-subview-drill",
  "/garden-planner.html?v=20260811-install-subview-drill&shell=20260811-install-subview-drill",
  ...
  "/garden-planner-page.js?v=20260811-install-subview-drill",
  "/styles.css?v=20260811-install-subview-drill",
  "/app.js?v=20260811-install-subview-drill",
  "/lib/order-money.js?v=20260811-install-subview-drill",
  "/lib/geo.js?v=20260811-install-subview-drill",
  "/lib/comuni-regioni.js?v=20260811-install-subview-drill",
  "/lib/sales-assignment.js?v=20260811-install-subview-drill",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260811-install-subview-drill",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260811-install-subview-drill",
  "/vendor/signature_pad.umd.min.js?v=20260811-install-subview-drill",
  "/vendor/html2pdf.bundle.min.js?v=20260811-install-subview-drill",
];
