const CACHE_NAME = "psi-ops-shell-20260531-sprint1-job-events";
const APP_SHELL = [
  "/",
  "/?shell=20260531-sprint1-job-events",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260531-sprint1-job-events",
  "/garden-planner.html?v=20260531-sprint1-job-events&shell=20260531-sprint1-job-events",
  ...
  "/garden-planner-page.js?v=20260531-sprint1-job-events",
  "/styles.css?v=20260531-sprint1-job-events",
  "/app.js?v=20260531-sprint1-job-events",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260531-sprint1-job-events",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260531-sprint1-job-events",
  "/sales-suite/generator.html?embedded=1&v=20260531-sprint1-job-events&shell=20260531-sprint1-job-events",
  "/sales-suite/generator-bridge.js?v=20260531-sprint1-job-events",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260531-sprint1-job-events",
];
