const CACHE_NAME = "psi-ops-shell-20260507-coverage-map-calibration-132";
const APP_SHELL = [
  "/",
  "/?shell=20260507-coverage-map-calibration-132",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260415-shell-reset-33",
  "/garden-planner.html?v=20260507-coverage-map-calibration-132&shell=20260507-coverage-map-calibration-132",
  ...
  "/garden-planner-page.js?v=20260507-coverage-map-calibration-132",
  "/styles.css?v=20260507-coverage-map-calibration-132",
  "/app.js?v=20260507-coverage-map-calibration-132",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/sales-suite/generator.html?embedded=1&v=20260507-coverage-map-calibration-132&shell=20260507-coverage-map-calibration-132",
  "/sales-suite/generator-bridge.js?v=20260507-coverage-map-calibration-132",
