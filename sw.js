const CACHE_NAME = "psi-ops-shell-20260530-timesheet-network-badges";
const APP_SHELL = [
  "/",
  "/?shell=20260530-timesheet-network-badges",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260530-timesheet-network-badges",
  "/garden-planner.html?v=20260530-timesheet-network-badges&shell=20260530-timesheet-network-badges",
  ...
  "/garden-planner-page.js?v=20260530-timesheet-network-badges",
  "/styles.css?v=20260530-timesheet-network-badges",
  "/app.js?v=20260530-timesheet-network-badges",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260530-timesheet-network-badges",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260530-timesheet-network-badges",
  "/sales-suite/generator.html?embedded=1&v=20260530-timesheet-network-badges&shell=20260530-timesheet-network-badges",
  "/sales-suite/generator-bridge.js?v=20260530-timesheet-network-badges",
  ...
  "/vendor/signature_pad.umd.min.js?v=20260530-timesheet-network-badges",
];
