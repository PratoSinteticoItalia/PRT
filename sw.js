const CACHE_NAME = "psi-ops-shell-20260716-inventario-visual-refresh";
const APP_SHELL = [
  "/",
  "/?shell=20260716-inventario-visual-refresh",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260716-inventario-visual-refresh",
  "/garden-planner.html?v=20260716-inventario-visual-refresh&shell=20260716-inventario-visual-refresh",
  ...
  "/garden-planner-page.js?v=20260716-inventario-visual-refresh",
  "/styles.css?v=20260716-inventario-visual-refresh",
  "/app.js?v=20260716-inventario-visual-refresh",
  "/lib/order-money.js?v=20260716-inventario-visual-refresh",
  "/lib/geo.js?v=20260716-inventario-visual-refresh",
  "/lib/comuni-regioni.js?v=20260716-inventario-visual-refresh",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260716-inventario-visual-refresh",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260716-inventario-visual-refresh",
  "/vendor/signature_pad.umd.min.js?v=20260716-inventario-visual-refresh",
  "/vendor/html2pdf.bundle.min.js?v=20260716-inventario-visual-refresh",
];
