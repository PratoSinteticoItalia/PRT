const CACHE_NAME = "psi-ops-shell-20260709-mobile-logout-settings";
const APP_SHELL = [
  "/",
  "/?shell=20260709-mobile-logout-settings",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260709-mobile-logout-settings",
  "/garden-planner.html?v=20260709-mobile-logout-settings&shell=20260709-mobile-logout-settings",
  ...
  "/garden-planner-page.js?v=20260709-mobile-logout-settings",
  "/styles.css?v=20260709-mobile-logout-settings",
  "/app.js?v=20260709-mobile-logout-settings",
  "/lib/order-money.js?v=20260709-mobile-logout-settings",
  "/lib/geo.js?v=20260709-mobile-logout-settings",
  "/lib/comuni-regioni.js?v=20260709-mobile-logout-settings",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260709-mobile-logout-settings",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260709-mobile-logout-settings",
  "/vendor/signature_pad.umd.min.js?v=20260709-mobile-logout-settings",
  "/vendor/html2pdf.bundle.min.js?v=20260709-mobile-logout-settings",
];
