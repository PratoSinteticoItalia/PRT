const CACHE_NAME = "psi-ops-shell-20260707-shell-sidebar-verde-scuro";
const APP_SHELL = [
  "/",
  "/?shell=20260707-shell-sidebar-verde-scuro",
  "/index.html",
  "/garden-planner.html",
  "/garden-planner.html?shell=20260707-shell-sidebar-verde-scuro",
  "/garden-planner.html?v=20260707-shell-sidebar-verde-scuro&shell=20260707-shell-sidebar-verde-scuro",
  ...
  "/garden-planner-page.js?v=20260707-shell-sidebar-verde-scuro",
  "/styles.css?v=20260707-shell-sidebar-verde-scuro",
  "/app.js?v=20260707-shell-sidebar-verde-scuro",
  "/lib/order-money.js?v=20260707-shell-sidebar-verde-scuro",
  "/lib/geo.js?v=20260707-shell-sidebar-verde-scuro",
  "/lib/comuni-regioni.js?v=20260707-shell-sidebar-verde-scuro",
  "/logo-prato.png",
  "/pwa-icon-192.png",
  "/pwa-icon-512.png",
  "/apple-touch-icon.png",
  "/manifest.webmanifest",
  "/preventivo-v2.html?embedded=1&p2=1&v=20260707-shell-sidebar-verde-scuro",
  "/preventivo-v2.html?embedded=1&p2=0&v=20260707-shell-sidebar-verde-scuro",
  "/vendor/signature_pad.umd.min.js?v=20260707-shell-sidebar-verde-scuro",
  "/vendor/html2pdf.bundle.min.js?v=20260707-shell-sidebar-verde-scuro",
];
