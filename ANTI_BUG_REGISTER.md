...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AB-001 | P2 | Dashboard | Layout | In alcune viste larghe resta molto spazio vuoto tra coda/dettaglio e moduli. | Dashboard, cambiare tab Vendite/Materiali/Soldi e scorrere la pagina. | Verificato su desktop | Il dettaglio operativo e sticky nel codice attuale e resta visibile durante lo scroll. Da ricontrollare con sweep mobile dedicato. |
...
- Sweep mobile completo ancora da eseguire come passaggio separato.
