...
export const NOTIFICATION_TYPES = {
  ...
  survey_assigned: { label: "Sopralluogo assegnato alla squadra", defaultChannels: ["inapp", "push"] },
  survey_completed: { label: "Sopralluogo completato dalla squadra", defaultChannels: ["inapp", "push"] },
  attendance_missing: { label: "Mancata timbratura", defaultChannels: ["inapp", "push"] },
