...
export const PRODUCTS = [
  { id: "tasso", name: "Tasso 12 mm", desc: "Ultra compatto", priceCliente: 5.9, priceRivenditore: 3.9 },
  { id: "bonsai", name: "Bonsai 18 mm", desc: "Compatto", priceCliente: 7.9, priceRivenditore: 6.5 },
  { id: "faggio", name: "Faggio 25 mm", desc: "Resistente", priceCliente: 10.9, priceRivenditore: 8.9 },
  { id: "betulla", name: "Betulla 30 mm", desc: "Vivace elegante", priceCliente: 11.5, priceRivenditore: 9.9 },
  { id: "gelso", name: "Gelso 30 mm", desc: "Morbido brillante", priceCliente: 16.0, priceRivenditore: 10.4 },
  { id: "cedro", name: "Cedro 30 mm", desc: "Versatile", priceCliente: 13.9, priceRivenditore: 10.9 },
  { id: "frassino", name: "Frassino 35 mm", desc: "Ultra realistico", priceCliente: 16.0, priceRivenditore: 10.4 },
  { id: "ginepro35", name: "Ginepro 35 mm", desc: "Equilibrato", priceCliente: 14.5, priceRivenditore: 11.9 },
  { id: "sequoia", name: "Sequoia 40 mm", desc: "Denso resistente", priceCliente: 18.0, priceRivenditore: 11.7 },
  { id: "rovere", name: "Rovere 40 mm", desc: "Naturale", priceCliente: 13.9, priceRivenditore: 11.9 },
  { id: "palma", name: "Palma 40 mm", desc: "Morbidezza", priceCliente: 18.9, priceRivenditore: 13.9 },
  { id: "cipresso", name: "Cipresso 40 mm", desc: "Multidirezionale", priceCliente: 16.9, priceRivenditore: 12.9 },
  { id: "ginepro45", name: "Ginepro 45 mm", desc: "Soffice equilibrato", priceCliente: 19.5, priceRivenditore: 13.9 },
  { id: "abete", name: "Abete 45 mm", desc: "Multidirezionale", priceCliente: 20.0, priceRivenditore: 13.0 },
  { id: "mogano", name: "Mogano 50 mm", desc: "Multidirezionale", priceCliente: 22.0, priceRivenditore: 14.3 },
];
